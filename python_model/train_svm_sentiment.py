...
def train_SVM_pipeline():
    ...
    final_model = LinearSVC(**best_params)
    ...
    model_path = os.path.join(MODELS_DIR, 'svm_sentiment_model.joblib')
    ...
    config_path = os.path.join(MODELS_DIR, 'svm_inference_config.json')
